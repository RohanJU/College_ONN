    ...
    <section style={{ backgroundColor: "#49BBBD" }} className="relative pb-24">
      ...
      <div className="max-w-7xl mx-auto px-6 py-20 flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="relative mt-10 md:mt-0">
          ...
          {/* 📦 Floating Box 2 */}
          <div className="absolute bottom-20 right-[350px] w-60 bg-white ... 
                sm:relative sm:bottom-0 sm:right-0 sm:w-full sm:max-w-xs sm:mx-auto sm:my-6">
            ...
            <button className="mt-2 bg-[#C23957] text-white mx-12 px-5 py-2 rounded-lg text-sm">
              Join Now
            </button>
          </div>
